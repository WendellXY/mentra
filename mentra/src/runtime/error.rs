...
pub enum RuntimeError {
    ...
    FailedToLoadExecutionContexts(std::io::Error),
    FailedToWriteExecutionContexts(std::io::Error),
    FailedToSerializeExecutionContexts(serde_json::Error),
    FailedToRestoreExecutionContexts(std::io::Error),
